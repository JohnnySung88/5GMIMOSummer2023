function [Time,Biterror,Capacity_sum,Rx1_SNR,Rx2_SNR,Lena_RGB] = Rx_fun_LDPC(Rx_signal,DTinfo,iteration)
	load('frame_data.mat');
	Fs 	= frame_data.Fs;
	Tx	= frame_data.Tx;
	Rx  = frame_data.Rx;
	...
	LDPC_num			 = size(LLR_part,2);
	LLR_MSA			  	 = LDPCMSAcustom(LLR_part,iteration,frame_data.H_row_master,frame_data.H_row_master_size,LDPC_num,0.5);
