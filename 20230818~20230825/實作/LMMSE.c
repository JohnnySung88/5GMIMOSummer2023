...
void matadd (double complex output[Tx][Tx],double complex input1[Tx][Tx]){
	output[1][0] = input1[1][0];
	output[0][1] = input1[0][1];
	output[0][0] = input1[0][0]+1;
	output[1][1] = input1[1][1]+1;
}
