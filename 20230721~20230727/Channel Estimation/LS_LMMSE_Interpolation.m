...
for a      = 1:length(SNR_in_dB)
    ...
    MSE_dB_LMMSE(1,a) = 10*log10( MSE_LMMSE / (1644 * 40  * frame_num) );
    MSE_dB_INTER(1,a) = 10*log10( MSE_INTER / (1644 * 560 * frame_num) );
end
